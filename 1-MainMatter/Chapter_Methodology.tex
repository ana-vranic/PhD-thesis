...
The interest in analyzing real-world networks allowed us to describe their statistical properties and formulate models that can capture essential features in the data. The network models are used to understand the origin of the properties of the complex networks and so on to describe the real data. Models of evolving random networks try to capture the mechanisms of network creation and understand their influence on the network structure. In this section are explained the most important models of complex networks. The random and small-world network models are static as network size stays constant. The random model was important historically. On the other hand, the small world model try to understand emergence of network features, such as high clustering and small distances.  For the first time, the Barabasi-Albert model introduced the growth of the networks, representing the class of evolving network models.
