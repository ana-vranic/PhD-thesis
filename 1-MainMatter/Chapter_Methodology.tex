...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{hurst_signals.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{hurst_detrending.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{hurst_mfdfa.pdf}
	\caption{Multifractal, monofractal and whitenoise signals.}
