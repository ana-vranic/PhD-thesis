...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.8\linewidth]{ciljevi.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.45\linewidth]{signal1.pdf}
	\includegraphics[width=0.45\linewidth]{signal2.pdf}\\
	
	\includegraphics[width=0.45\linewidth]{signal4.pdf}
	\includegraphics[width=0.45\linewidth]{signal5.pdf} \\
    \begin{center}
	
	\includegraphics[width=0.45\linewidth]{signal3.pdf}
	\end{center}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\linewidth]{hurst.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\textwidth]{b1.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\textwidth]{b3.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\textwidth]{b2.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{Ddistance.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{monofractals.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.45\textwidth]{aindex.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\textwidth]{Ddist_M4_w10.5_w20.5.png}
