...
\begin{figure}[h]
	...
	\begin{minipage}[b]{0.45\textwidth}
		...
		\vspace{1cm}
	\end{minipage}
	\caption{TECH signal, the random TECH signal (left pane) and the dependence of multi fractal Hurst exponent $H(q)$ of the scale $q$. (right pane)}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.55\textwidth]{aindex.pdf}
...
\begin{figure}[h]
	...
	\includegraphics[width=0.55\textwidth]{clustering.pdf}
