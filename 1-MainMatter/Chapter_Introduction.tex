...
%or changing connection strength between nodes.
While these changes occur, the structure, but also the function of the network could be affected. The formation of clusters, hubs, and node removal directly influence network connectivity and robustness \cite{boccaletti2006complex}. %%TODO referenca 
