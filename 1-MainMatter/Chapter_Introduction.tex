...
While the structure of social networks is characterized by the relationships between individuals, the dynamics is related to the changes in the individual behaviors, as example creation new connections. As real complex networks constantly evolve, the interactions between its elements can also change \cite{thurner2018}. One of the key aspects of the network dynamics is their evolution over time. Networks can grow with addition of new nodes, removal of existing nodes or even the changes in the strength of connection between nodes. As these changes occur, the structure, but also the function of the network could be affected. Formation of clusters, hubs, node removal change network connectivity, network robustness. 
...
%One way in which structure affrects function is through the emergence of network properties such as connectivity, and efficiency. For example in transportation network connectivity of different cities and towns may influnce the flow of goods and sevices. 





%The internet structure is characterized by its vast number of interconnected devices, The internet dynamics is related to changes in user behavior. The function of internet is to enable communication and access to information. Recent research has shown that the internet;s structure and dynamics hav e important implications for its function with network bttlenecks and congestion affecting user experience and network preformance. (Barabasi 2016). 

%In the field of social networks. The structure of social networks is characterized by the relationships between individuals. The dynamics of social networks is related to the changes in individual behaviour, spreding informations, or creating new friendships/connections. 
...
%The interactions between the complex system elements are not homogeneous; as systems evolve, they can also change \cite{thurner2018}. 
...
Socio-physics is an interdisciplinary field that applies the principles of statistical physics and complex systems theory to study social phenomena. It identify the universal properties of social systems and explore the underlying mechanisms that govern social interactions and it aims to provide the quantitative understanding of the structure and dynamics of the social systems. Social systems are very dynamical.  Even though they constantly change and evolve, they show some universal properties.
Studies have shown that social networks exhibit a number of universal properties, such as the small-world property and the power-law degree distribution. The small-world property states that any two individuals in a social network can be connected by a relatively small number of intermediate connections. The power-law degree distribution refers to the fact that the majority of nodes in a social network have a relatively small number of connections, while a small number of nodes have a very large number of connections. These properties have been observed in a wide range of social networks, from online social networks to professional networks and biological networks.
The understanding how they emerge is important for description of complex networks. In this thesis we will explore structure and dynamics of evolving social complex networks. 
